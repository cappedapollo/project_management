...
// import { DB_MENU, DB_PERMISSION, DB_ROLE, DB_ROLE_PERMISSION, DB_USER, DB_USER_ROLE } from "../assets_backup"; // Removed for production
const DB_MENU: any[] = [];
const DB_PERMISSION: any[] = [];
const DB_ROLE: any[] = [];
const DB_ROLE_PERMISSION: any[] = [];
const DB_USER: any[] = [];
const DB_USER_ROLE: any[] = [];
